...
<div class="fest-bottom-bar" style="position:relative;z-index:2;padding:32px 56px;border-top:1px solid rgba(255,255,255,0.04);display:flex;align-items:center;justify-content:space-between;gap:24px;flex-wrap:wrap;">
  ...
  <div style="display:flex;gap:8px;flex-wrap:wrap;">
    <?php
    $socials = [
      ['https://instagram.com/afrobassfest','Instagram','<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="0.5" fill="currentColor" stroke="none"/></svg>'],
